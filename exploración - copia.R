...
EM21F$DIV_n[EM21$DIV == "00"] <- "00"
EM21F$DIV_n[EM21$DIV == "01"] <- "Agricultura, ganadería, caza y actividades de servicios conexas" 
EM21F$DIV_n[EM21$DIV == "02"] <- "Silvicultura y extracción de madera"
EM21F$DIV_n[EM21$DIV == "03"] <- "Pesca y acuicultura"
EM21F$DIV_n[EM21$DIV == "05"] <- "Extracción de carbón de piedra y lignito"
EM21F$DIV_n[EM21$DIV == "06"] <- "Extracción de petróleo crudo y gas natural"
EM21F$DIV_n[EM21$DIV == "07"] <- "Extracción de minerales metalíferos"
EM21F$DIV_n[EM21$DIV == "08"] <- "Extracción de otras minas y canteras"
EM21F$DIV_n[EM21$DIV == "09"] <- "Actividades de servicios de apoyo para la explotación de minas y canteras"
EM21F$DIV_n[EM21$DIV == "10"] <- "Elaboración de productos alimenticios"
EM21F$DIV_n[EM21$DIV == "11"] <- "Elaboración de bebidas" 
EM21F$DIV_n[EM21$DIV == "12"] <- "Elaboración de productos de tabaco"
EM21F$DIV_n[EM21$DIV == "13"] <- "Fabricación de productos textiles"
EM21F$DIV_n[EM21$DIV == "14"] <- "Confección de prendas de vestir"
EM21F$DIV_n[EM21$DIV == "15"] <- "Curtido y recurtido de cueros; fabricación de calzado;fabricación de artículos de viaje, maletas, bolsos de mano y artículos similares, y fabricación de artículos de talabartería y guarnicionería; adobo y teñido de pieles"
EM21F$DIV_n[EM21$DIV == "16"] <- "Transformación de la madera y fabricación de productos de madera y de corcho, excepto muebles; fabricación de artículos de cestería y espartería"
EM21F$DIV_n[EM21$DIV == "17"] <- "Fabricación de papel, cartón y productos de papel y cartón"
EM21F$DIV_n[EM21$DIV == "18"] <- "Actividades de impresión y de producción de copias a partir de grabaciones originales"
EM21F$DIV_n[EM21$DIV == "19"] <- "Coquización, fabricación de productos de la refinación del petróleo y actividad de mezcla de combustibles"
EM21F$DIV_n[EM21$DIV == "20"] <- "Fabricación de sustancias y productos químicos"
EM21F$DIV_n[EM21$DIV == "21"] <- "Fabricación de productos farmacéuticos, sustancias químicas medicinales y productos botánicos de uso farmacéutico" 
EM21F$DIV_n[EM21$DIV == "22"] <- "Fabricación de productos de caucho y de plástico"
EM21F$DIV_n[EM21$DIV == "23"] <- "Fabricación de otros productos minerales no metálicos"
EM21F$DIV_n[EM21$DIV == "24"] <- "Fabricación de productos metalúrgicos básicos"
EM21F$DIV_n[EM21$DIV == "25"] <- "Fabricación de productos elaborados de metal, excepto maquinaria y equipo"
EM21F$DIV_n[EM21$DIV == "26"] <- "Fabricación de productos informáticos, electrónicos y ópticos"
EM21F$DIV_n[EM21$DIV == "27"] <- "Fabricación de aparatos y equipo eléctrico"
EM21F$DIV_n[EM21$DIV == "28"] <- "Fabricación de maquinaria y equipo n.c.p."
EM21F$DIV_n[EM21$DIV == "29"] <- "Fabricación de vehículos automotores, remolques y semirremolques"
EM21F$DIV_n[EM21$DIV == "30"] <- "Fabricación de otros tipos de equipo de transporte"
EM21F$DIV_n[EM21$DIV == "31"] <- "Fabricación de muebles, colchones y somieres" 
EM21F$DIV_n[EM21$DIV == "32"] <- "Otras industrias manufactureras"
EM21F$DIV_n[EM21$DIV == "33"] <- "Instalación, mantenimiento y reparación especializado de maquinaria y equipo"
EM21F$DIV_n[EM21$DIV == "35"] <- "Suministro de electricidad, gas, vapor y aire acondicionado"
EM21F$DIV_n[EM21$DIV == "36"] <- "Captación, tratamiento y distribución de agua"
EM21F$DIV_n[EM21$DIV == "37"] <- "Evacuación y tratamiento de aguas residuales"
EM21F$DIV_n[EM21$DIV == "38"] <- "Recolección, tratamiento y disposición de desechos,recuperación de materiales"
EM21F$DIV_n[EM21$DIV == "39"] <- "Actividades de saneamiento ambiental y otros servicios de gestión de desechos"
EM21F$DIV_n[EM21$DIV == "41"] <- "Construcción de edificios" 
...
EM21F$DIV_n[EM21$DIV == "45"] <- "Comercio, mantenimiento y reparación de vehículos automotores y motocicletas, sus partes, piezas y accesorios"
EM21F$DIV_n[EM21$DIV == "46"] <- "Comercio al por mayor y en comisión o por contrata, excepto el comercio de vehículos automotores y motocicletas"
EM21F$DIV_n[EM21$DIV == "47"] <- "Comercio al por menor (incluso el comercio al por menor de combustibles), excepto el de vehículos automotores y motocicletas"
